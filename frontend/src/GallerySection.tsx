  ...
  const galleryImages = [
    {
      ...
      alt: "Vista panorámica de las montañas",
      category: "Paisajes"
    },
    {
      src: "https://images.unsplash.com/photo-1441974231531-c6227db76b6e?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
      alt: "Bosque nativo local",
      category: "Naturaleza"
    },
    {
    ...
    {
      src: "https://images.unsplash.com/photo-1533147670608-2a2f9d775d0e0?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
      alt: "Artesanías tradicionales",
      category: "Cultura"
    },
    {
    ...
    <section id="galeria" className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl text-gray-900 mb-4">Galería Visual</h2>
